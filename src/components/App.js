...
class App extends Component {
        ...
        const networkData = KryptoBird.networks[networkId]
         if(networkData) {
            ...
            for(let i = 1; i <= totalSupply; i++) {
                ...
                // handle the state on the front end
                this.setState({
    ...
    mint = (kryptoBird) => {
        if(this.state.contract){ // https://stackoverflow.com/questions/62038184/typeerror-cannot-read-property-methods-of-null
